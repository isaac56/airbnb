...
-- -----------------------------------------------------
-- Table `airbnb`.`accommodation_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `airbnb`.`accommodation_image` ;

CREATE TABLE IF NOT EXISTS `airbnb`.`accommodation_image` (
                                                              `id` BIGINT NOT NULL AUTO_INCREMENT,
